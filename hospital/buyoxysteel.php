    ...
    <div class="panel-heading" role="tab" id="headingOne" >
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          Purchase Stainless Steel Cylinder
        </a>
      </h4>
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
        ...
        <div class="col-xs-8 col-md-6">
             ...
             <div style="height:370px; width:1100px;background-color:#EBF5FB;border: 3px solid blue; ">
               ...
               <br><center> 
               <img src="images/steel.jpg" width="80" height="80"></img>
               
               Available Cylinders in Stainless Steel
               ...
               <table style="font-size:12px;margin-left:0px;border:2px;" border="2" >
                 ...
                 <?php
                     $sql = "SELECT * FROM oxystock where material = 'Stainless Steel'";
                     $result = $con->query($sql);
