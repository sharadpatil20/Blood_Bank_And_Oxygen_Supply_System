    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
        ...
        <div class="col-xs-8 col-md-6">
             ...
             <div style="border: 3px solid blue;height:370px; width:1100px;background-color:#EBF5FB; ">
                  ...
                  <hr>
                  <div style="margin-left:20px;height:250px; width:500px; background-color:white;text-align:center">
                  ...
                  <div style="margin-top:-250px;margin-left:550px;height:250px; width:520px; background-color:white;;text-align:center">
