    ...
    <div class="panel-heading" role="tab" id="headingOne" >
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          Suppliers Table - All Registred Suppliers.
        </a>
      </h4>
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
        ...
        <div class="col-xs-8 col-md-6">
             ...
             <div style="border: 3px solid blue;height:350px; width:1100px;background-color:#EBF5FB; ">
                  ...
                  <?php
                      $sql = "SELECT * FROM profile where type ='Blood Bank' or type='Oxygen Supplier'";
                      $result = $con->query($sql);
                      ...
                      if ($result->num_rows > 0) 
                      {
                        ...
                        while($i<$n)
                        {
                          $row1 = $result->fetch_row();
                          $type = $row1['5'];
                          echo "<tr><td>".$row1['1']."</td><td>".$type."</td><td>".$row1['2']."</td><td>".$row1['3']."</td><td>".$row1['4']."</td></tr>";
                          $i++;
                        } 
                      }                   
