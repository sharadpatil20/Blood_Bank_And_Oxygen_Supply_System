    ...
    <div class="panel-heading" role="tab" id="headingOne" >
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          View or edit stock of Oxygen Cylinders
        </a>
      </h4>
                ...
                <!-- <tr> 
                  ...
                  <?php
                      ...
                      if ($result->num_rows > 0) 
                      {
                        ...
                        {
                          $row1 = $result->fetch_row();
                          echo "<tr><td>".$row1['2']."</td><td>".$row1['3']."</td><td>".$row1['4']."</td><td>".$row1['5']."</td>
                          <td>".$row1['6']."</td><td>".$row1['7']."</td><td>".$row1['8']."</td></tr>"; // <td><a href=blstockedit.php?id=".$row1['0'].">Edit</a>  |  <a href=blstockdel.php?id=".$row1['0'].">Delete</a></td>
                          $i++;
                        } 
                      }                   
