    ...
    <div class="panel-heading" role="tab" id="headingOne" >
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
         Available Stock of Medical Supplies
        </a>
      </h4>
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
        ...
        <div class="col-xs-8 col-md-6">
             ...
             <div style="border: 3px solid blue;height:370px; width:1100px;background-color:#EBF5FB; ">
                  ...
                  <hr>
                  <div style="overflow-y: scroll;border: 3px solid pink;margin-left:20px;height:250px; width:500px; background-color:white;text-align:center">
                    <br><span style="text-align:center; margin-left:20px;font-size:15px;font-weight:bold">Oxygen Cylinder</span>
                    <hr> 
                    <center> 
                    <table style="overflow:scroll;font-size:12px;margin-left:0px;border:2px;" border="2" >
                 ...
                 <?php
                     ...
                     if ($result->num_rows > 0) 
                     {
                       ...
                       {
                         $row1 = $result->fetch_row();
                         echo "<tr><td>".$row1['2']."</td><td>".$row1['4']."</td><td>".$row1['7']."</td><td>".$row1['8']."</tr>";
                         $i++;
                       } 
                     }                   
                 ...
                 ?>
                  ...
                  <div style="overflow-y: scroll;border: 3px solid pink;margin-top:-250px;margin-left:550px;height:250px; width:520px; background-color:white;;text-align:center">
                    <br><span style="margin-left:20px;font-size:15px;font-weight:bold">Blood Bags for Transfusion</span>
                    <hr> 
                    <center> 
                  ...
                  <?php
                      ...
                      if ($result->num_rows > 0) 
                      {
                        ...
                        {
                          $row1 = $result->fetch_row();
                          echo "<tr><td>".$row1['2']."</td><td>".$row1['3']."</td><td>".$row1['4']."</td></tr>";
                          $i++;
                        } 
                      }                   
