  ...
  <div class="panel panel-primary" style="height:450px;margin-top:0px;">
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
        ...
        <div class="col-xs-8 col-md-6">
             ...
             <div style="border: 3px solid blue;height:370px; width:1100px;background-color:#EBF5FB;overflow-y: scroll; ">
                  <br>
                      ...
                      if (mysqli_connect_errno()){
                          ...
                          if ($result->num_rows > 0) 
                          {
                              ...
                              while($i<$n)
                              {
                                ...
                                echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<span style=font-size:15px;font-weight:bold;>
                                      Your order with order no : ".$row1['1']." is confirmed, the date of order is ".$row1['4']." Thanks for your support !!.<br>";
                                $i++;
                              } 
                      }
                  ?>
                  <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Track your orders <a href="orders.php">Here </a>
