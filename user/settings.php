        ...
        <div class="col-xs-8 col-md-6">
             ...
             <div style="border: 3px solid blue;height:370px; width:1100px;background-color:#EBF5FB; ">
                  ...
                  <tr> 
                    ...
                    <td width="100"><input size="30" type="password" name="told1" placeholder="Enter Old Password" required /></td>
                  ...
                  <tr colspan="2"> 
                      ...
                      <center>
                      <br>  
                      <input class="btn-default btn-cf-submit" style="background-color:lightblue" type="submit" value="Update" />
