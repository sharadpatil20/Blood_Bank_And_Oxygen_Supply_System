    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
        ...
        <div class="col-xs-8 col-md-6">
             ...
             <div style="border: 3px solid blue;height:370px; width:1100px;background-color:#EBF5FB; ">
                  ...
                  <hr>
                  <div style="border: 3px solid pink;margin-left:20px;height:250px; width:500px; background-color:white;text-align:center">
                    <br><span style="text-align:center; margin-left:20px;font-size:15px;font-weight:bold">Purchase Oxygen Cylinder</span>
                    <br> <center> <a href="buyoxygen.php"><img src="images/oc.jpg" height="200" width="200" /></a></center>
                  </div>
                  <div style="border: 3px solid pink;margin-top:-250px;margin-left:550px;height:250px; width:520px; background-color:white;;text-align:center">
                    <br><span style="margin-left:20px;font-size:15px;font-weight:bold">Purchase Blood Bags for Transfusion</span>
                    <br> <center> <a href="buyblood.php"><img src="images/bb.jpg" height="200" width="200" /></a></center>  
                </div>
              </div>
