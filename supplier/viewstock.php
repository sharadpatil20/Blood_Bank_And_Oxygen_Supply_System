    ...
    <div class="panel-heading" role="tab" id="headingOne" >
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          View or edit stock of Blood Bags
        </a>
      </h4>
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
        ...
        <div class="col-xs-8 col-md-6">
             ...
             <div style="height:370px; width:1100px;background-color:#EBF5FB;border: 3px solid blue; ">
                  ...
                  <hr>
                  <div style="overflow-y: scroll;border: 3px solid pink;margin-top:0px;margin-left:50px;height:250px; width:1000px; background-color:white;;text-align:center">
                <center>
                <table style="font-size:12px;margin-left:50px;margin-top:10px;border:2px;" border="2">
                <!-- <tr> 
                  ...
                  <?php
                      ...
                      if ($result->num_rows > 0) 
                      {
                        ...
                        while($i<$n)
                        {
                          ...
                          </tr>"; // <td><a href=blstockedit.php?id=".$row1['0'].">Edit</a>  |  <a href=blstockdel.php?id=".$row1['0'].">Delete</a></td>
                          $i++;
                        } 
                      }                   
